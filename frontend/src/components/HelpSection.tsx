    ...
    <section id='help' className='surfaceCard stackGap'>
      ...
      <div className='miniCard warningCard'>
        ...
        <ul className='featureList'>
          ...
          <li>AI-модели используются для увеличения разрешения и колоризации ч/б фото;</li>
          <li>AI-увеличение разрешения запускается для изображений до {AI_UPSCALE_LIMIT_LABEL};</li>
          ...
          <li>большие AI-upscale изображения переводятся в fallback OpenCV/Pillow;</li>
          <li>часть сценариев выполняется backend-обработкой OpenCV/Pillow;</li>
          <li>режим "Для сайта" уменьшает изображение и сохраняет его в выбранном формате;</li>
