export function AboutSection() {
  ...
  const capabilities = [
    ...
    'Demo mode при недоступности API или модели',
  ];
  ...
  return (
    <section id='about' className='surfaceCard stackGap'>
      ...
      <p className='sectionText'>
        AI Image Processing предназначен для браузерной обработки цифровых
        изображений. Пользователь загружает файл, выбирает режим, настраивает
        параметры, запускает обработку, сравнивает результат и скачивает
        готовое изображение.
      </p>
      ...
      <div className='twoCols'>
        ...
        <div className='miniCard'>
          ...
          <p className='sectionText'>
            ...
            модели, показывает метаданные файла и может работать в demo mode для
            демонстрации интерфейса без полноценной AI-обработки.
          </p>
        </div>
      </div>
    </section>
